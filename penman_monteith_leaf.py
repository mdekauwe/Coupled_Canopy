...
class PenmanMonteith(object):
    ...
    def calc_net_radiation(self, doy, hod, latitude, longitude, sw_rad, tair,
    ...
    def calculate_solar_geometry(self, doy, hod, latitude, longitude):
        """
    ...
    def calculate_solar_noon(self, et, longitude):
        """
    ...
    def calc_extra_terrestrial_rad(self, doy, cos_zenith):
        """
